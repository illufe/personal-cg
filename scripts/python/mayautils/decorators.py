...
def d_promptSaveScene(message=None):

	message = message or 'Your scene has unsaved changes. Save before proceeding?'

	def wrapper(f):
		if cmd.about(batch=True):
			return f
